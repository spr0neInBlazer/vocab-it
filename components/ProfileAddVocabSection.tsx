  ...
  return (
    <article>
      ...
      {isAddVocab ? (
        ...
        >
          <input 
            className="text-lg px-2 rounded border border-zinc-400 dark:border-zinc-300 max-w-[150px]" 
            value={newVocab} 
        ...
        <button 
          className="flex gap-1 items-center justify-center mobile:justify-start w-full mobile:w-fit rounded-lg py-1 px-3 font-semibold text-white bg-btnBg hover:bg-hoverBtnBg transition-colors"
