...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ...
    className={cn(
      "flex cursor-default select-none items-center rounded-sm text-sm font-medium outline-none focus:bg-transparent focus:text-slate-900 data-[state=open]:bg-transparent data-[state=open]:text-slate-900 dark:focus:text-slate-50 dark:data-[state=open]:text-slate-50",
      className
    )}
    {...props}
  />
